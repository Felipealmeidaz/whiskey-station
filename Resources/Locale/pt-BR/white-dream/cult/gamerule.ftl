blood-cult-title = O Culto de Sangue
blood-cult-description = A mais antiga e forte emoção da humanidade é o medo, e o mais antigo e forte tipo de medo é o medo do desconhecido.

roles-antag-blood-cultist-name = Cultista de sangue
roles-antag-blood-cultist-objective = Invoque o Velho Deus Nar'Sie.

blood-cult-role-greeting = A Geômetra de Sangue, Nar'Sie, enviou vários de seus seguidores à Estação Espacial 14.
    Como cultista, você tem à disposição uma abundância de magias do culto, algo para toda situação.
    Você deve trabalhar com seus irmãos para invocar o avatar de sua deusa eldritch!
    Sacrifique o alvo marcado e rasgue o véu para invocar Nar'Sie. A discrição é sua maior aliada.

blood-cult-role-briefing-short = Use a ação Comunhão para falar com seus irmãos em qualquer lugar da estação.
    Estude o véu para ver o estado do culto, seus objetivos e onde o véu está fino.
blood-cult-role-briefing-rending-locations = O véu pode ser rasgado {$location}, {$coordinates}
blood-cult-role-briefing-rending-site = O véu é fino { $location }.
...
blood-cult-ui-roundstart-text-1 = Você é um cultista da Geômetra de Sangue!
blood-cult-ui-roundstart-text-2 = Sacrifique seu alvo marcado e rasgue o véu para invocar Nar'Sie.
blood-cult-ui-roundstart-text-3 = Fale Eldritch com ^ para alcançar seus irmãos. A discrição é sua maior aliada.
blood-cult-ui-popup-confirm = Entendido

blood-cult-objective-sacrifice-title = Sacrifique { $targetName } ({ CAPITALIZE($job) })

blood-cult-roundend-stats-cultists = O culto tinha { $count } cultistas
blood-cult-roundend-stats-constructs = { $count } constructos foram criados
blood-cult-roundend-stats-stage = Estágio alcançado pelo culto: { $stage }

blood-cult-stage-start = inicial
blood-cult-stage-red-eyes = olhos vermelhos
blood-cult-stage-pentagram = pentagrama
