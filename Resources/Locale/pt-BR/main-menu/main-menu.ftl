...
main-menu-join-public-server-button = Entrar no servidor público
main-menu-join-public-server-button-tooltip = Não é possível conectar ao servidor público usando uma compilação de depuração.
