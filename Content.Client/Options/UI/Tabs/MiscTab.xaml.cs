...
public sealed partial class MiscTab : Control
{
    ...
    public MiscTab()
    {
        ...
        // <Trauma>
        Control.AddOptionCheckBox(GoobCVars.LogInChat, LogInChatCheckBox);
        Control.AddOptionCheckBox(GoobCVars.CoalesceIdenticalMessages, CoalesceIdenticalMessagesCheckBox);
        Control.AddOptionCheckBox(GoobCVars.DetailedExamine, DetailedExamineCheckBox);
        // </Trauma>
